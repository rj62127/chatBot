...
small_talk = ['hi there!', 'hi!', 'how do you do?', 'how are you', 'i\'m cool.', 'fine, you?', 'always cool.',
...
math_talk1 = ['pythagorean theorem', 'a squared plus b squared equals c squared.']
